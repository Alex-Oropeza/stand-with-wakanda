...
info.onScore(20, function () {
    ...
    Shuri.sayText("WAKANDA FOREVR", 5000, false)
})
let Namor: Sprite = null
let Shuri: Sprite = null
game.showLongText("Help Shuri, Okoye and Siri escape Namor.", DialogLayout.Full)
game.showLongText("When game begins, press the ARROW KEYS to move shuri, Okoye and Namor. S", DialogLayout.Bottom)
